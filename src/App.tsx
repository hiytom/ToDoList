  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="relative mx-auto flex h-full w-full max-w-7xl p-[var(--pagePY)]"
      >
        <div
          className="flex h-full min-h-0 w-full flex-col overflow-hidden rounded-[22px] border shadow-[0_18px_48px_rgba(15,23,42,0.10)]"
          style={{
            borderColor: "var(--border)",
            background: dark ? "rgba(11, 15, 20, 0.86)" : "rgba(255, 255, 255, 0.82)",
        ...
        >
          ...
          <div
            ...
            className="grid min-h-0 flex-1 grid-cols-[292px_minmax(0,1fr)_272px] gap-3 p-3"
          >
            <TodoSection
              controls={controls}
              pending={pending}
            ...
            <div
              ...
              className="grid min-h-0 grid-rows-[minmax(0,0.8fr)_192px] gap-3"
            >
              <CalendarSection
                lang={lang}
